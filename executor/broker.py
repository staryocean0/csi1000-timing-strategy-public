...
PUBLIC_REPO = "staryocean0/csi1000-timing-strategy-public"
PRIVATE_REPO = "staryocean0/csi1000-timing-strategy-private"
...
def main():
    ...
    if args.phase == "runtime-smoke":
        ...
        return
    raise GateError("legacy_baseline_not_registered_for_csi1000")
