"""Bounded public research broker for CSI1000 handoff. Never print private bytes or pass credentials to compute."""
...
SOURCE_ROOT = "handoff"
SOURCE_PATHS = (
    f"{SOURCE_ROOT}/package_helpers.py",
