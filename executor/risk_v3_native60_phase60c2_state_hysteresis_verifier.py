...
def verify(inputs:Path,results:Path):
    path=results/"NATIVE60_PHASE60C2_STATE_HYSTERESIS.json"
    ...
    return {"status":"passed","scientific_status":got["status"],"eligible_count":got["eligible_count"],"selected":None if got["selected_state"] is None else got["selected_state"]["candidate_id"]}
