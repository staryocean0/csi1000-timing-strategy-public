"""Mirror verified V0800-E audit text plus the frozen deterministic SVG pack to the private run branch."""
...
def main() -> None:
    ...
    for case in manifest["cases"]:
        ...
        if not isinstance(relative, str) or not re.fullmatch(r"visuals/[A-Za-z0-9_.-]+\.svg", relative) or relative in seen:
    ...
    print(f"Verified Two-Wave V0800-E frozen audit pack mirrored privately: {len(seen)} SVG cases.")
