"""Reviewed broker for Two-Wave V0800-F fixed-parameter state-stream audit."""
...
PROFILE_NAME = "two-wave-v0800-f-state-stream-audit-v1"
...
PROTOCOL = HERE.parent / "docs" / "research" / "TWO_WAVE_V0800_F_STATE_STREAM_PROTOCOL.json"
SCRIPT_NAMES = (
