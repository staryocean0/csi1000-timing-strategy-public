"""Fixed market entry for recognizer R1 progress-aware reset study."""
import argparse,hashlib,json,math
from pathlib import Path
import numpy as np
from wave_recognizer_r1_v1 import analyze
...
def write_results(out,report):
 ...
 m={'files':{'report.json':{'bytes':len(raw),'sha256':hashlib.sha256(raw).hexdigest()}},'new_training':False,'production_authority':False}
