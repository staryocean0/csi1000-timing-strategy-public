"""Fixed market entry for recognizer R2 eligible-counter-shadow study."""
...
def main():
 ...
 bars=load_market(a.inputs);report,candidate,base,r1=analyze(bars);write_results(a.out,report)
 from wave_recognizer_r2_v1_visuals import write_pack
