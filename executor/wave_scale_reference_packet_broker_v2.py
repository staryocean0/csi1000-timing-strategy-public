...
ROOT=HERE.parent
PROFILE='two-wave-scale-reference-blind-packet-v2'
...
COMMAND=['scale_reference_packet/wave_scale_reference_packet_entry_v2.py']
VERIFY=['scale_reference_packet/wave_scale_reference_packet_verifier_v2.py']
SOURCES=(
 'wave_scale_reference_packet_v2.py','wave_scale_reference_packet_entry_v2.py',
 'wave_scale_reference_packet_verifier_v2.py','wave_scale_reference_sampling_v2.py',
...
def load_manifest():
    ...
    if set(value)!=required or value['schema_id']!='csi1000.scale_reference_packet_execution@2.0':
    ...
    if blob(HERE/'wave_scale_reference_packet_broker_v2.py')!=value['broker_blob']:raise rb.GateError('broker_identity')
...
def publish(profile):
    ...
    api.request(target,{'message':'Record scale-reference packet v2 aggregate [skip ci]',
