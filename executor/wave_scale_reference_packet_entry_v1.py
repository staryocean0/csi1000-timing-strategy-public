"""Fixed no-argument entry for #359 blind reference packet generation."""
from __future__ import annotations
import hashlib,json,re
from pathlib import Path
import pandas as pd
from wave_scale_reference_packet_v1 import build_packet,result_manifest
...
def load_protocol():
    ...
    if p.get('schema_id')!='csi1000.scale_reference_packet_protocol@1.0':raise RuntimeError('protocol_identity')
    if p.get('profile')!='two-wave-scale-reference-blind-packet-v1':raise RuntimeError('profile_identity')
