...
def load_protocol():
    ...
    if p.get('schema_id')!='csi1000.scale_reference_packet_protocol@2.0':raise RuntimeError('protocol_identity')
    if p.get('profile')!='two-wave-scale-reference-blind-packet-v2':raise RuntimeError('profile_identity')
