...
class FixedLagLoyoAdjudicationTests(unittest.TestCase):
    ...
    def test_lineage_and_authority_advance_without_rewriting_history(self):
        ...
        self.assertIn(lane['status'], {'FIXED_LAG_DEVELOPMENT_LOYO_NOT_READY_OBJECTIVE_ABSTENTION_COLLAPSE_NO_LAG_PROMOTION','CALIBRATION_V3_SOURCE_READY_NOT_RUN','CALIBRATION_V3_NOT_READY_AMBIGUITY_RECALL_COLLAPSE_VALIDITY_RECALL_LOW_NO_FULL_FIT'})
