...
class ReferenceAnnotationAdjudicationTests(unittest.TestCase):
    ...
    def test_authority_moves_to_diagnostic_measurement_only(self):
        ...
        self.assertIn(lane['status'],{'PRIMARY_REFERENCE_LABELS_FROZEN_DIAGNOSTIC_MEASUREMENT_REGISTRATION_NEXT','DIAGNOSTIC_MEASUREMENT_PROFILE_SOURCE_READY_NOT_RUN','DIAGNOSTIC_MEASUREMENT_AND_THRESHOLD_FREE_JOIN_COMPLETED_CALIBRATION_GATE_NEXT','VALIDITY_DIAGNOSTIC_PROFILE_SOURCE_READY_NOT_RUN','VALIDITY_MEASUREMENT_PASSED_CALIBRATION_ENGINE_SOURCE_READY_NOT_FIT','FIRST_REAL_LOYO_FAILED_DIAGNOSTIC_FAMILY_REVISION_REQUIRED','DIAGNOSTIC_FAMILY_V2_PROFILE_SOURCE_READY_NOT_RUN','V2_DEVELOPMENT_LOYO_NOT_READY_ABSTENTION_COLLAPSE_NO_FULL_FIT','FIXED_LAG_CONFIRMATION_PROFILE_SOURCE_READY_NOT_RUN','FIXED_LAG_DEVELOPMENT_LOYO_NOT_READY_OBJECTIVE_ABSTENTION_COLLAPSE_NO_LAG_PROMOTION','CALIBRATION_V3_SOURCE_READY_NOT_RUN','CALIBRATION_V3_NOT_READY_AMBIGUITY_RECALL_COLLAPSE_VALIDITY_RECALL_LOW_NO_FULL_FIT','CALIBRATION_V4_SOURCE_READY_NOT_RUN'})
        self.assertIn(self.u['S2_progress']['next'],{'REGISTER_POST_REFERENCE_DIAGNOSTIC_ONLY_MARKET_MEASUREMENT','MERGE_PROFILE_THEN_FORMAL_DIAGNOSTIC_ONLY_MARKET_MEASUREMENT','REGISTER_STATE_MORPHOLOGY_CONDITIONAL_CALIBRATION_AND_VALIDITY_GUARD_GATE','MERGE_VALIDITY_PROFILE_THEN_FORMAL_LABEL_BLIND_MEASUREMENT','MERGE_CALIBRATION_ENGINE_THEN_RUN_FROZEN_LOYO_OOF','PREREGISTER_DIAGNOSTIC_FAMILY_REVISION_V2','MERGE_DIAGNOSTIC_FAMILY_V2_PROFILE_THEN_FORMAL_LABEL_BLIND_MEASUREMENT','PREREGISTER_V3_CALIBRATION_OBJECTIVE_AND_VALIDITY_FAMILY_REVISION_BEFORE_FURTHER_LABEL_CONDITIONAL_SEARCH','PREREGISTER_FIXED_LAG_CAUSAL_CONFIRMATION_FAMILY_BEFORE_FURTHER_LABEL_CONDITIONAL_SEARCH','MERGE_FIXED_LAG_PROFILE_THEN_FORMAL_LABEL_BLIND_MEASUREMENT','PREREGISTER_COVERAGE_CONSTRAINED_MORPHOLOGY_OBJECTIVE_V3_AND_VALIDITY_REVISION','MERGE_CALIBRATION_V3_THEN_RUN_FROZEN_FIXED_LAG_LOYO','RUN_THRESHOLD_FREE_AMBIGUITY_AND_VALIDITY_CAPACITY_AUDIT_BEFORE_V4_PREREGISTRATION','MERGE_CALIBRATION_V4_THEN_RUN_FROZEN_FIXED_LAG_LOYO'})
