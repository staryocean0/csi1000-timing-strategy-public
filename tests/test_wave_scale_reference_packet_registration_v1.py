...
from tests.segmentation_carrier_registration_support import (
    ...
    PACKET_BROKER as BROKER, PACKET_V2_PROFILE, strip_packet_workflow, strip_packet_controller,
)
...
class PacketRegistrationTests(unittest.TestCase):
    ...
    def test_profile_option_and_shared_public_stage(self):
        ...
        self.assertEqual(stage[0]['if'],f"inputs.profile == '{CARRIER_PROFILE}' || inputs.profile == '{PROFILE}' || inputs.profile == '{PACKET_V2_PROFILE}'")
    ...
    def test_thread_authority_is_registered_not_run(self):
        ...
        self.assertIn('V1_PACKET_FAILED_CLOSED',lane['status'])
        self.assertEqual(a['S2_progress']['market_packet_run'],'35205287251-1_FAILED')
