...
class CalibrationSourceTests(unittest.TestCase):
    ...
    def test_authority_advances_only_to_source_ready(self):
        ...
        self.assertIn(lane["status"], {"VALIDITY_MEASUREMENT_PASSED_CALIBRATION_ENGINE_SOURCE_READY_NOT_FIT","FIRST_REAL_LOYO_FAILED_DIAGNOSTIC_FAMILY_REVISION_REQUIRED","DIAGNOSTIC_FAMILY_V2_PROFILE_SOURCE_READY_NOT_RUN","DIAGNOSTIC_FAMILY_V2_MEASUREMENT_PASSED_CALIBRATION_SOURCE_NEXT"})
