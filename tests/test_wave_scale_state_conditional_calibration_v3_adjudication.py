...
class CalibrationV3AdjudicationTests(unittest.TestCase):
 ...
 def test_authority_is_not_promoted(self):
  ...
  self.assertIn(lane['status'],{'CALIBRATION_V3_NOT_READY_AMBIGUITY_RECALL_COLLAPSE_VALIDITY_RECALL_LOW_NO_FULL_FIT','CALIBRATION_V4_SOURCE_READY_NOT_RUN','CALIBRATION_V4_NOT_READY_AMBIGUITY_RECALL_LOW_VALIDITY_RECALL_LOWER_NO_FULL_FIT'})
  self.assertIn(self.u['S2_progress']['next'],{'RUN_THRESHOLD_FREE_AMBIGUITY_AND_VALIDITY_CAPACITY_AUDIT_BEFORE_V4_PREREGISTRATION','MERGE_CALIBRATION_V4_THEN_RUN_FROZEN_FIXED_LAG_LOYO','RUN_POST_V4_ERROR_AND_CAPACITY_AUDIT_BEFORE_ANY_V5_PREREGISTRATION'})
