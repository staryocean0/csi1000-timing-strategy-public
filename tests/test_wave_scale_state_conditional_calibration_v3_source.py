...
class CalibrationV3SourceTests(unittest.TestCase):
    ...
    def test_dominance_and_authority_not_promoted(self):
        ...
        self.assertIn(lane["status"], {"CALIBRATION_V3_SOURCE_READY_NOT_RUN","CALIBRATION_V3_DEVELOPMENT_OOF_NOT_READY_AMBIGUITY_VALIDITY_REVISION_REQUIRED"})
        self.assertIn(self.a["S2_progress"]["next"], {"MERGE_CALIBRATION_V3_THEN_RUN_FROZEN_FIXED_LAG_LOYO","PREREGISTER_CALIBRATION_V4_THREE_CLASS_AMBIGUITY_AND_BROADER_VALIDITY_FAMILY"})
        self.assertIn(self.a["S2_progress"]["calibration_v3_real_oof_run"], {False,"COMPLETED_DEVELOPMENT_NOT_READY"})
