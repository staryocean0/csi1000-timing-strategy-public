...
class CalibrationV3SourceTests(unittest.TestCase):
    ...
    def test_dominance_and_authority_not_promoted(self):
        ...
        self.assertEqual(lane["status"], "CALIBRATION_V3_SOURCE_READY_NOT_RUN")
        self.assertEqual(self.a["S2_progress"]["next"], "MERGE_CALIBRATION_V3_THEN_RUN_FROZEN_FIXED_LAG_LOYO")
        self.assertFalse(self.a["S2_progress"]["calibration_v3_real_oof_run"])
