...
class V4Source(unittest.TestCase):
 ...
 def test_authority(self):
  ...
  self.assertIn(lane['status'],{'CALIBRATION_V4_SOURCE_READY_NOT_RUN','CALIBRATION_V4_NOT_READY_AMBIGUITY_RECALL_LOW_VALIDITY_RECALL_LOWER_NO_FULL_FIT'})
  self.assertIn(a['S2_progress']['next'],{'MERGE_CALIBRATION_V4_THEN_RUN_FROZEN_FIXED_LAG_LOYO','RUN_POST_V4_ERROR_AND_CAPACITY_AUDIT_BEFORE_ANY_V5_PREREGISTRATION'})
