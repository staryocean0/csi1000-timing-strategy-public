...
class LoyoAdjudicationTests(unittest.TestCase):
 ...
 def test_authority_moves_to_revision_not_candidate_fit(self):
  ...
  self.assertIn(lane['status'],{'FIRST_REAL_LOYO_FAILED_DIAGNOSTIC_FAMILY_REVISION_REQUIRED','DIAGNOSTIC_FAMILY_V2_PROFILE_SOURCE_READY_NOT_RUN','V2_DEVELOPMENT_LOYO_NOT_READY_ABSTENTION_COLLAPSE_NO_FULL_FIT'})
