...
class ValidityMarketRegistrationTests(unittest.TestCase):
    ...
    def test_authority_is_registered_not_run(self):
        ...
        self.assertIn(lane["status"], {"VALIDITY_DIAGNOSTIC_PROFILE_SOURCE_READY_NOT_RUN","VALIDITY_MEASUREMENT_PASSED_CALIBRATION_ENGINE_SOURCE_READY_NOT_FIT","FIRST_REAL_LOYO_FAILED_DIAGNOSTIC_FAMILY_REVISION_REQUIRED","DIAGNOSTIC_FAMILY_V2_PROFILE_SOURCE_READY_NOT_RUN","V2_DEVELOPMENT_LOYO_NOT_READY_ABSTENTION_COLLAPSE_NO_FULL_FIT"})
