...
from tests.segmentation_carrier_registration_support import PROFILE,BROKER,PACKET_PROFILE,PACKET_V2_PROFILE,PACKET_V3_PROFILE,strip_workflow,strip_controller
...
class RegistrationTests(unittest.TestCase):
    ...
    def test_public_stage_exactly_once_and_without_secret(self):
        ...
        self.assertEqual(stage[0]['if'],f"inputs.profile == '{PROFILE}' || inputs.profile == '{PACKET_PROFILE}' || inputs.profile == '{PACKET_V2_PROFILE}' || inputs.profile == '{PACKET_V3_PROFILE}'")
